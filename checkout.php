...
<section style="height:460px" class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      <input type="submit" style="width: 252px; position:relative; bottom: -430px; right: -280px;"  name="order" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>" value="place order">
